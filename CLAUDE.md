...
npm test -- tests/unit/feature-flags.test.js  # Single test file
...
### Subscription Plans
Defined in `backend/config/plans.js`:
...
- **Pro (99 PLN):** 50+ exports, 1-min schedule, all features, unlimited members
